...
<script>
    ...
    data() {
      return {
        ...
        tableData: [{
          info: '第一大节',
          mon: '王小虎',
          thu: '上海市普陀区金沙江路 1518 弄',
          wes: '上海市普陀区金沙江路 1517 弄',
          fur: '上海市普陀区金沙江路 1519 弄',
          fri: '上海市普陀区金沙江路 1520 弄',
          sta: '上海市普陀区金沙江路 1521 弄',
          sun: '上海市普陀区金沙江路 1522 弄'
  ...
  methods: {
    ...
    getData() {
      ...
      this.$axios.get('http://127.0.0.1:8080/courseTable/'+cookie_id).then(res => {
