    ...
    gettableData() {
      ...
      this.$axios.get('http://127.0.0.1:8080/courseTable/'+cookie_id+'/'+this.semester).then(res => {
        ...
        for (let i = 0; i < res.data.length; i++){
          ...
          course['coursetime']= res.data[i].courseTime.sections;
          console.log(course);
          //console.log(course+'grade:'+res.data.grade+'state:'+res.data.state)
          this.tableData.push(course);
        }
        for (let i = 0; i < table.length; i++) {
          this.tableData[i]['name'] = table[i].course.name;
          this.tableData[i]['classroom'] = table[i].course.classroom;
          this.tableData[i]['sections'] = table[i].courseTime.sections;
