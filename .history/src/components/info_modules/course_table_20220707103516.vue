  ...
  methods: {
    ...
    getweek(num, course) {
      ...
      if (num === '1') {
        ...
        this.tableData[1]['thu'] = course.coursename+'\n'+course.classroom;
      }
      else if(num=== '3'){
        this.tableData[2]['wes'] = course.coursename+'\n'+course.classroom;
      }
      else if(num=== '4'){
        this.tableData[3]['fur'] = course.coursename+'\n'+course.classroom;
      }
      else if(num=== '5'){
        this.tableData[4]['fri'] = course.coursename+'\n'+course.classroom;
      }
      else if(num=== '6'){
        this.tableData[5]['sta'] = course.coursename+'\n'+course.classroom;
      }
      else if(num=== '7'){
      ...
      this.$axios.get('http://127.0.0.1:8080/courseTable/' + cookie_id + '/' + this.semester).then(res => {
        ...
        for (let index = 0; index < coursetable.length; index++) {
          ...
          for (let i = 0; i < stutime.length; i++) {
            ...
            if (stutime[i][1] === '1-2') {
              this.getweek(stutime[i][0],i, coursetable[index]);
            }
