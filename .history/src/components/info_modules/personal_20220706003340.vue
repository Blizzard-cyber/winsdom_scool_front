...
<div class="main flex-col flex-x-center flex-y-center">
    ...
    <div class="container">
  	  ...
  	  <div class="banner">
  	    ...
  	    <el-button type="primary" @click="open">修改信息</el-button>
  	  </div>
  	</div>  
...
<script>
  ...
  methods: {
    getInfo() {
      ...
      this.$axios.post(url).then(res => { }).catch(err => {
        console.log(err)
      });
...
<style scoped>
	...
	.info{float:right;width: 60%;text-align: left;margin-top: 10px;}
  ...
  .el-button{margin-top: 100px;margin-right: 500px;}
</style>
